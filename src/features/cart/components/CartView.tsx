            ...
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
              ...
              <div className="space-y-4 lg:col-span-2">
                {cart.map((item) => (
                  <div
                    key={item.id}
                    className="flex items-center md:justify-between md:gap-4 rounded-xl border border-slate-200 bg-white md:p-4 shadow-sm"
                  >
                    ...
                    <div className="flex items-center md:gap-2">
                      <div className="flex items-center  rounded-lg border border-slate-200 bg-slate-50 md:p-1 ">
                        <button
              ...
              <div className="h-fit rounded-2xl border border-slate-200 bg-white p-6 shadow-md space-y-4">
                ...
                <Link
                  href="/checkout"
                  className="block w-full text-center rounded-xl bg-slate-900 py-1 md:py-2 text-lg font-bold text-white hover:bg-slate-800 transition-all shadow-sm"
                >
                  Checkout
                </Link>
              </div>
